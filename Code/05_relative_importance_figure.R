...
out.dir <- "Figures/"
### CSCI 
gbm_fin_RI_csci <- read.csv("models/03_rel_imp_csci_labels.csv")
gbm_fin_RI_asci <- read.csv("models/04_rel_imp_asci_labels.csv")
...
write.csv(all_rf, "output_data/05_relative_imp_table.csv")
